...
then
        # B가 실행 중인 경우
        START_CONTAINER=hoodies_react_container_blue
        TERMINATE_CONTAINER=hoodies_react_container_green
        START_PORT=3000
        TERMINATE_PORT=3001
else
        # A가 실행 중인 경우
        START_CONTAINER=hoodies_react_container_green
        TERMINATE_CONTAINER=hoodies_react_container_blue
        START_PORT=3001
        TERMINATE_PORT=3000
fi
